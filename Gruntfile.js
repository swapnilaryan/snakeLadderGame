// Generated on 2017-11-03 using generator-angular 0.16.0
'use strict';
...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			...
			jsTest: {
				files: ['test/spec/{,*/}*.js'],
				tasks: ['newer:jshint:test', 'new`er:jscs:test', 'karma']
			},
			styles: {
		...
		ngtemplates: {
			dist: {
				options: {
					module: 'inBoundPartnerSupportApp',
